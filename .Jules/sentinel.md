...
**Vulnerability:** Output file paths were written to without validating their extensions, allowing potential overwrites of critical non-image files (e.g., executables, scripts) even within allowed scopes.
