...
## 2024-10-18 - [Range Input Accessibility]
**Learning:** In this project's UI, standard HTML5 controls like `<input type="range">` do not automatically inherit global focus styles. Missing id/htmlFor bindings also prevent screen readers from associating labels.
