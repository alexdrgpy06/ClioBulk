...
## 2026-08-25 - [Range Input Accessibility]
**Learning:** Form elements such as sliders were not explicitly associated with their visual labels, causing screen readers to announce them as 'slider' without context.
**Action:** Explicitly link <label> and <input> using matching htmlFor and id attributes when building custom range settings or form controls.
