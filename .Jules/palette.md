...
## 2024-05-24 - [Explicit Forms Controls A11y]
...
**Action:** You must explicitly apply Tailwind `focus-visible` utility classes (e.g., `focus-visible:ring-2`) and provide `aria-valuetext` along with proper `<label>` `htmlFor`/`id` bindings to ensure full keyboard and screen reader accessibility.
