...
## 2024-07-16 - [Keyboard Accessibility for Standard HTML Controls]
...
**Action:** Always test native HTML elements for keyboard navigation visually and apply explicit `focus-visible` utilities and ARIA associations where missing.
