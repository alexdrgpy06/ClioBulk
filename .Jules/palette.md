...
## 2024-05-28 - Missing global focus styles on standard inputs
**Learning:** Standard HTML5 controls like `<input type="range">` elements do not inherit global focus styles in this project.
