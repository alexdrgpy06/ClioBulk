...
## 2026-04-01 - [Range Inputs Accessibility]
...
**Action:** Always add explicit `focus-visible` utility classes, `aria-valuetext`, and explicitly link `<label>` with `id` and `htmlFor` to native form controls for proper keyboard and screen reader accessibility.
