              ...
              <section>
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <input id="brightness-slider" type="range" min="-1" max="1" step="0.1" value={processingOptions.brightness} aria-valuetext={`${(processingOptions.brightness * 100).toFixed(0)} percent`} onChange={(e) => setProcessingOptions({...processingOptions, brightness: parseFloat(e.target.value)})} className="w-full accent-blue-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-black rounded-full" />
                  </div>
                  <div className="space-y-2">
                    ...
                    <input id="contrast-slider" type="range" min="0" max="3" step="0.1" value={processingOptions.contrast} aria-valuetext={`${processingOptions.contrast.toFixed(1)} times`} onChange={(e) => setProcessingOptions({...processingOptions, contrast: parseFloat(e.target.value)})} className="w-full accent-blue-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 focus-visible:ring-offset-black rounded-full" />
                  </div>
                  <div className="space-y-2">
