...
function App() {
  ...
  const downloadAll = useCallback(() => {
    // ⚡ Bolt: Replace O(N) array lookup with O(1) Map generated locally
    // to avoid severe O(N^2) slowdown on large batches, without
    // causing main thread thrashing from a useMemo cache.
