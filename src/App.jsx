...
function App() {
  ...
  const downloadAll = useCallback(() => {
    ...
    // Generate an ID-to-File map locally to avoid O(N^2) array finds during batch iteration.
    // Avoids useMemo as files array updates constantly, which would cause thrashing.
