                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    <div className="flex justify-between text-xs">
                      <label htmlFor="brightness-input" className="text-zinc-400">Brightness</label>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-xs">
                      <label htmlFor="contrast-input" className="text-zinc-400">Contrast</label>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-xs">
                      <label htmlFor="saturation-input" className="text-zinc-400">Saturation</label>
