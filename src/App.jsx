              ...
              <section>
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <input id="brightness" type="range" min="-1" max="1" step="0.1" value={processingOptions.brightness} onChange={(e) => setProcessingOptions({...processingOptions, brightness: parseFloat(e.target.value)})} className="w-full accent-blue-600 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950" aria-valuetext={`${(processingOptions.brightness * 100).toFixed(0)} percent`} />
                  </div>
                  <div className="space-y-2">
                    ...
                    <input id="contrast" type="range" min="0" max="3" step="0.1" value={processingOptions.contrast} onChange={(e) => setProcessingOptions({...processingOptions, contrast: parseFloat(e.target.value)})} className="w-full accent-blue-600 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950" aria-valuetext={`${processingOptions.contrast.toFixed(1)}x`} />
                  </div>
                  <div className="space-y-2">
                    ...
                    <input id="saturation" type="range" min="0" max="2" step="0.1" value={processingOptions.saturation} onChange={(e) => setProcessingOptions({...processingOptions, saturation: parseFloat(e.target.value)})} className="w-full accent-blue-600 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950" aria-valuetext={`${processingOptions.saturation.toFixed(1)}x`} />
                  </div>
                </div>
              </section>
            </div>
