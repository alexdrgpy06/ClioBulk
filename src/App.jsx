...
function App() {
  ...
  const downloadAll = useCallback(() => {
    ...
    // O(1) file lookup using Map instead of O(N) array.find inside loop, reducing time complexity from O(N^2) to O(N).
    // Map created locally to avoid useMemo thrashing on frequently updated files store array.
