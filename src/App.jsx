      ...
      <header className="border-b border-zinc-800 p-4 flex items-center justify-between sticky top-0 bg-black/80 backdrop-blur-md z-10">
        ...
        <div className="flex items-center gap-4">
          <button 
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-full transition-all focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-black ${showSettings ? 'bg-blue-600 shadow-lg shadow-blue-600/30' : 'bg-zinc-800 hover:bg-zinc-700'}`}
          >
            <Settings size={18} />
          ...
          {Object.keys(processedFiles).length > 0 && (
            <button 
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-full bg-green-600 hover:bg-green-500 transition-all shadow-lg shadow-green-600/20 focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-black"
            >
              <Download size={18} />
              <span className="hidden sm:inline text-sm font-medium">Download All</span>
            </button>
          )}
          <button disabled={files.length === 0 || processing} onClick={startProcessing} className="flex items-center gap-2 px-6 py-2 rounded-full bg-blue-600 hover:bg-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-blue-600/20 focus-visible:ring-2 focus-visible:ring-white focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-black">
              ...
              <section>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input id="saturation-slider" aria-valuetext={`${processingOptions.saturation.toFixed(1)}x`} type="range" min="0" max="2" step="0.1" value={processingOptions.saturation} onChange={(e) => setProcessingOptions({...processingOptions, saturation: parseFloat(e.target.value)})} className="w-full accent-blue-600 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950" />
                  </div>
                </div>
              </section>
            </div>
