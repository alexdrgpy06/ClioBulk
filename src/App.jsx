              ...
              <section>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input id="saturation-slider" type="range" min="0" max="2" step="0.1" aria-valuetext={`${processingOptions.saturation.toFixed(1)}x`} value={processingOptions.saturation} onChange={(e) => setProcessingOptions({...processingOptions, saturation: parseFloat(e.target.value)})} className="w-full accent-blue-600 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 rounded-full" />
                  </div>
                </div>
              </section>
            </div>
