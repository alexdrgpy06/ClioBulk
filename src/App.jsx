...
function App() {
  ...
  const downloadAll = useCallback(() => {
    // Performance optimization: Generate ID-to-File map locally to prevent O(N^2) lookups
    // during batch downloads. We avoid useMemo to prevent main thread thrashing on file updates.
