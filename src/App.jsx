...
function App() {
  ...
  const downloadAll = useCallback(() => {
    ...
    // Replaced O(N^2) nested loop array lookup with O(N) Map lookup for fast file retrieval.
    // Structure is generated locally to avoid useMemo main thread thrashing from the frequently updating files array.
