...
function App() {
  ...
  const downloadAll = useCallback(() => {
    // Performance optimization: Generate ID-to-File map locally to replace O(N^2) array lookup
    // with O(N) hash map lookup without causing main thread thrashing from useMemo
