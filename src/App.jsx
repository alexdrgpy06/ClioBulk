...
function App() {
  ...
  const downloadAll = useCallback(() => {
    // ⚡ Bolt: Replace O(N^2) nested loop with O(N) hash map lookup for processing large file sets
    // Avoid useMemo here to prevent main thread thrashing from constant files state updates
