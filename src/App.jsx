...
function App() {
  ...
  const downloadAll = useCallback(() => {
    // Performance Optimization: Create an O(1) lookup map locally to avoid O(N^2) loop bottleneck.
    // Avoids useMemo on 'files' global state to prevent severe main thread thrashing during batch processing.
