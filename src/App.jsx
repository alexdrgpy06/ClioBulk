...
function App() {
  ...
  const downloadAll = useCallback(() => {
    ...
    // Replaced O(N^2) nested array lookup with O(N) Map lookup.
    // When downloading hundreds of files, `files.find()` inside the loop
    // causes UI freezes. Using a Map makes the lookups O(1).
