...
function App() {
  ...
  const downloadAll = useCallback(() => {
    // Performance Optimization: Create a lookup map locally to avoid O(N^2) complexity
    // during batch downloads without triggering useMemo thrashing on every progress update.
