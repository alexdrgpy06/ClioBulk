              ...
              <section>
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <input id="brightness-slider" type="range" min="-1" max="1" step="0.1" value={processingOptions.brightness} aria-valuetext={`${(processingOptions.brightness * 100).toFixed(0)} percent`} onChange={(e) => setProcessingOptions({...processingOptions, brightness: parseFloat(e.target.value)})} className="w-full accent-blue-600 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950" />
                  </div>
                  <div className="space-y-2">
