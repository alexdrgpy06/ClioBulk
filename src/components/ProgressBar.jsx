...
const ProgressBar = () => {
  // Only subscribe to `processing` state to toggle visibility
  const processing = useStore((state) => state.processing);

  // Reference to the progress bar element to bypass React renders
  ...
  useEffect(() => {
    ...
    // Subscribe to progress changes directly, bypassing React renders
