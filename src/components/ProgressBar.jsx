...
const ProgressBar = () => {
  // Optimization: Only subscribe to 'processing' here to avoid re-renders on every progress tick.
  ...
  useEffect(() => {
    ...
    // Bypass React renders for high-frequency progress state updates
